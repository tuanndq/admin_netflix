  ...
  return (
    <div className="new-episode">
      ...
      <div className="new-episode-element">
        ...
        <textarea rows="4" id="desc" onChange={(e) => handleChange(e, 'desc')} />
      </div>
      <div className="new-episode-element">
      ...
      <div className="new-episode-element">
        ...
        <input type="number" id="duration" onChange={(e) => handleChange(e, 'duration')} />
      </div>
      <div className="new-episode-element">
        <label htmlFor="seasonName">Belongs To Movie</label>
        <div className="new-episode-element-child">
          <label htmlFor="seasonName">Season name</label>
          <input type="text" id="seasonName" onChange={(e) => handleChange(e, 'seasonName')} />
          <label htmlFor="movieName">Movie name</label>
          <input type="text" id="movieName" onChange={(e) => handleChange(e, 'movieName')} />
        </div>
      </div>
      <button className="episode_submit_btn" onClick={handleSubmit} >Create</button>
    </div>
  )
}