...
import { getAllFilms, getAllLists, updateListById } from '../../redux/actions/action'
    ...
    <div className="newList">
      ...
      <div className="form_element">
        ...
        <input type="text" id="list_type" 
          value={editList.type} onChange={(e) => setEditList({ ...editList, type: e.target.value })} 
        />
      </div>
      ...
      <div className="form_element">
        ...
        <input type="text" id="list_genre" 
          value={editList.genre} onChange={(e) => setEditList({ ...editList, genre: e.target.value })} 
        />
      </div>
